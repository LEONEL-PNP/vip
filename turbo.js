...
//Welkom
		    ...
		    teks += `                                                 \n`
            teks += `╭┅─═•ঈ⋆❥🔮❥⋆ঈ•═─┅╮\n`
            teks += `╽Hola 👋🏻 espero que se  ╽\n`
			teks += `┃Sienta como en casa      ┃\n`
            teks += `┃ 🍿 🍭 🍫 🍬 🍡  🤗 ┃\n`
            teks += `┃Disfruta del grupo 🥳    ┃\n`
            teks += `┃Se sociable y aporta😊 ┃\n`
            teks += `┃Espero hagas amig@s   ┃\n`
            teks += `┃Lee las reglas porfavor  ┃\n`
            teks += `╿       👻 🔫 💣🧨💥    ╿\n`
			teks += `╰┅─═•ঈ⋆❥🔮❥⋆ঈ•═─┅╯\n`
...
//
		...
		mess = {
			wait: '✪᭄ꦿ᭄ꦿ  𝐄𝐬𝐩𝐞𝐫𝐚, 𝐞𝐧 𝐩𝐫𝐨𝐜𝐞𝐬𝐨',
			success: 'Comando con  éxito 😏',
			wrongFormat: '✪᭄ꦿ᭄ꦿ 𝐄𝐬𝐜𝐫𝐢𝐛𝐞 𝐛𝐢𝐞𝐧 𝐞𝐥 𝐟𝐨𝐫𝐦𝐚𝐭𝐨',
			leveloff: 'La nivelación no está habilitado en el grupo', 
			error: {
				stick: 'lo siento 🚮 no se pudo convertir a sticker',
				Iv: '✪᭄ꦿ᭄ꦿ 𝐓𝐮 𝐥𝐢𝐧𝐤 𝐞𝐬 𝐢𝐧𝐯𝐚𝐥𝐢𝐝𝐨'
			},
			only: {
				group: '✪᭄ꦿ᭄ꦿ 𝐄𝐬𝐭𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐬𝐨𝐥𝐨 𝐩𝐮𝐞𝐝𝐞 𝐬𝐞𝐫 𝐮𝐬𝐚𝐝𝐨 𝐞𝐧 𝐠𝐫𝐮𝐩𝐨𝐬',
				admin: '✪᭄ꦿ᭄ꦿ 𝐒𝐨𝐥𝐨 𝐩𝐮𝐞𝐝𝐞 𝐬𝐞𝐫 𝐮𝐭𝐢𝐥𝐢𝐳𝐚𝐝𝐨 𝐩𝐨𝐫 𝐚𝐝𝐦𝐢𝐧',
				Badmin: '✪᭄ꦿ᭄ꦿ 𝐄𝐥 𝐛𝐨𝐭 𝐝𝐞𝐛𝐞 𝐝𝐞𝐫 𝐚𝐝𝐦𝐢 𝐩𝐚𝐫𝐚 𝐞𝐬𝐭𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨'
			}
		}
		const isUrl = (url) => {
...
//----𝗔𝗨𝗧𝗢 𝗥𝗘𝗦𝗣𝗨𝗘𝗦𝗧𝗔
        ...
        case 'tóxica':
buf = fs.readFileSync(`./mp3/12k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'teamobot':
buf = fs.readFileSync(`./mp3/11k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'no':
buf = fs.readFileSync(`./mp3/10k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'bam':
buf = fs.readFileSync(`./mp3/9k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'eliminacion':
buf = fs.readFileSync(`./mp3/8k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'uwu':
buf = fs.readFileSync(`./mp3/7k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'adm':
buf = fs.readFileSync(`./mp3/6k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'puto':
buf = fs.readFileSync(`./mp3/5k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'buenas':
buf = fs.readFileSync(`./mp3/3k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'hola':
buf = fs.readFileSync(`./mp3/2k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
        case 'turbo':
buf = fs.readFileSync(`./mp3/1k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break        	
        case 'bot':
buf = fs.readFileSync(`./mp3/4k.mp3`)
turbo.sendMessage(from, buf, audio, {mimetype: 'audio/mp4', quoted: mek, ptt: true})
break
...
╽➣͜͡᳆⃟⋆Busquedas᳆͜͡➣╽
├➤͜͡🌻 ${prefix}igstalk             ❦᭄
├➤͜͡🌷 ${prefix}tiktokstalk       ❦᭄
├➤͜͡🌞 ${prefix}video                ❦᭄
├➤͜͡🍁 ${prefix}ytsearch          ❦᭄
├➤͜͡🌟 ${prefix}google             ❦᭄
├➤͜͡🌸 ${prefix}brainly             ❦᭄
├➤͜͡🌛 ${prefix}twich               ❦᭄ 
╰─═•⋆ঈ❥💥❥ঈ⋆•═─╯
...
├➤͜͡⚡ ${prefix}husbu              ❦᭄
├➤͜͡🍁 ${prefix}image              ❦᭄
├➤͜͡🌛 ${prefix}pinterest         ❦᭄
├✦͜͡🌹 ${prefix}anime              ❦᭄
├➤͜͡🌻 ${prefix}wallpaper       ❦᭄
├➤͜͡🌷 ${prefix}mujer              ❦᭄
├➤͜͡🌞 ${prefix}hombre           ❦᭄
├➤͜͡🍁 ${prefix}cyberpunk      ❦᭄
╰─═•⋆ঈ❥💝❥ঈ⋆•═─╯

╭─═•⋆ঈ❥💮❥ঈ⋆•═─╮
╽  ➣͜͡᳆⃟⋆Grupos᳆͜͡➣    ╽
├➤͜͡🌻 ${prefix}leveling <on/off>❦᭄
├➤͜͡🌻 ${prefix}level                 ❦᭄
├➤͜͡🌷 ${prefix}promote @      ❦᭄
├➤͜͡🌞 ${prefix}demote @       ❦᭄
├➤͜͡🍁 ${prefix}kick @             ❦᭄
├➤͜͡🌟 ${prefix}listadmin        ❦᭄
├➤͜͡🌸 ${prefix}listonline         ❦᭄
├➤͜͡⚡ ${prefix}linkge              ❦᭄
├✦͜͡🌹 ${prefix}gay @              ❦᭄
├➤͜͡🌛 ${prefix}rate                 ❦᭄
├➤͜͡♚ ${prefix}leave               ❦᭄
...
├➤͜͡🌷 ${prefix}abrir               ❦᭄
├➤͜͡🌻 ${prefix}welcome        ❦᭄
├➤͜͡🍁 ${prefix}antilink           ❦᭄
├➤͜͡🌟 ${prefix}demoteall      ❦᭄
├➤͜͡🌸 ${prefix}rankgay          ❦᭄
├➤͜͡⚡ ${prefix}ranklindo        ❦᭄
├✦͜͡🌹 ${prefix}afk                   ❦᭄
╰─═•⋆ঈ❥💮❥ঈ⋆•═─╯

╭─═•⋆ঈ❥🧿❥ঈ⋆•═─╮
╽     ➣͜͡᳆⃟⋆Otros᳆͜͡➣     ╽
├➤͜͡🌻 ${prefix}covidworld      ❦᭄
├➤͜͡🌷 ${prefix}cnn                   ❦᭄
├ ͜͡🌞 ${prefix}revip [ 8.8.8.8 ]  ❦᭄
├➤͜͡🍁 ${prefix}runtime            ❦᭄
├➤͜͡🌟 ${prefix}speed              ❦᭄
├➤͜͡🌸 ${prefix}d                       ❦᭄
├➤͜͡🌛 ${prefix}getbio @         ❦᭄
...
├➤͜͡🌟 ${prefix}upsw               ❦᭄
├➤͜͡🌸 ${prefix}upswimg        ❦᭄
├➤͜͡⚡ ${prefix}upswvideo     ❦᭄
├✦͜͡🌹 ${prefix}bc                    ❦᭄
├➤͜͡🌛 ${prefix}setthumb       ❦᭄
├➤͜͡♚ ${prefix}setprefix         ❦᭄
├➤͜͡🌻 ${prefix}setfakeimg    ❦᭄
├➤͜͡🌞 ${prefix}noprefix         ❦᭄
├➤͜͡♚ ${prefix}mute               ❦᭄
├➤͜͡🌜 ${prefix}unmute          ❦᭄
├✦͜͡🌹 ${prefix}spam              ❦᭄
├➤͜͡🌻 ${prefix}on                   ❦᭄
├➤͜͡🌷 ${prefix}off                   ❦᭄
├➤͜͡🌞 ${prefix}setbio             ❦᭄
├➤͜͡🍁 ${prefix}setreply          ❦᭄
├➤͜͡⚡ ${prefix}pin                   ❦᭄
├➤͜͡🌸 ${prefix}unpin               ❦᭄
├➤͜͡🌛 ${prefix}archive            ❦᭄
├✦͜͡🌹 ${prefix}archiveall        ❦᭄
├➤͜͡🌜 ${prefix}readall             ❦᭄
├➤͜͡♚ ${prefix}unreatdall         ❦᭄
├➤͜͡🌟 ${prefix}chat                  ❦᭄
├➤͜͡🌷 ${prefix}apagar             ❦᭄
 ╰─═•⋆ঈ❥🍁❥ঈ⋆•═─╯
...
case prefix+ 'infoall':
					...
					mentions(`*From :* ${pushname} \n*Info :*  ${body.slice(9)}\n*Total Member :* ${groupMembers.length} \n\n┏━━━⟪ *INFORMATION* ⟫━━━┓`+teks+'╚═ *「 𝐓𝐔𝐑𝐁??✪𝐍𝐓𝐑 」* ', members_id, true)
					break
case prefix+ 'emoji':
...
╭•⋆҈͜͡◄⫘⫘❯✪❮⫘⫘▻⋆҈͜͡•╮
   ...
   En el canal TURBO NTR 
    Depende de tu apoyo 
       para que este bot 
      siga funcionando

  https://youtu.be/PqUZPvDN-yg?sub_confirmatión=1
╰•⋆҈͜͡ ⫘𝐓𝐔𝐑𝐁𝐎⋆𝐍𝐓𝐑⫘⋆҈͜͡•╯
`
faketokoforwaded(her)
break
   case prefix+ 'canal':
			case prefix+ 'chanel':
                  reply ('╭•⋆҈͜͡◄⫘⫘❯✪❮⫘⫘▻⋆҈͜͡•╮ https://youtube.com/c/turbontr1?sub_confirmatión=1 ╰⸙⋆҈͜͡⋆⫘⫘❯✪❮⫘⫘⋆҈͜͡⋆⸙╯')
                break
case prefix+ 'creador':
			case prefix+ 'dueño':
                  reply ('╭•⋆҈͜͡◄⫘⫘❯✪❮⫘⫘▻⋆҈͜͡•╮ Mi creador es turbo Wa.me/+12244253896 ╰⸙⋆҈͜͡⋆⫘⫘❯✪❮⫘⫘⋆҈͜͡⋆⸙╯')
                break
case prefix+ 'tomp3':
